      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center items-center gap-4 md:gap-2 py-8 px-2 max-w-5xl mx-auto">
        {PHOTO_GALLERY.map((photo, index) => (
          <div
            ...
            className="group relative bg-white p-3 sm:p-4 rounded-2xl border border-neutral-200/80 shadow-md hover:shadow-2xl transition-all duration-300 hover:rotate-0 hover:scale-105 hover:z-20 cursor-pointer w-full sm:w-64 md:w-1/4"
          >
            {/* Tag Badge */}
            <div className="absolute top-5 right-5 z-10 bg-black/60 backdrop-blur-xs text-white text-[10px] font-medium px-2 py-0.5 rounded-full opacity-90">
              {photo.tag}
            </div>

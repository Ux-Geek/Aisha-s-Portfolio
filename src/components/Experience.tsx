    ...
    <section id="experience" className="py-16 px-4 sm:px-6 max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        {EXPERIENCES.map((item) => (
          <div
            key={item.id}
            className="bg-[#fbfbfb] border-[0.5px] border-[#dcdcdc] rounded-[20px] p-6 sm:p-8 transition-all duration-200 hover:border-neutral-400"
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
              ...
              {/* Date */}
              <div className="text-xs font-medium text-neutral-700 bg-[#fbfbfb] border-[0.5px] border-[#dcdcdc] px-3 py-1 rounded-[20px] self-start sm:self-auto shrink-0">
                {item.period}
              </div>
            </div>

            {/* Bullets Box */}
            <div className="bg-[#fbfbfb] rounded-[20px] border-[0.5px] border-[#dcdcdc] p-5 sm:p-6">

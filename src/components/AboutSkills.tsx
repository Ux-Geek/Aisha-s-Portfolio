...
export const AboutSkills: React.FC = () => {
  return (
    <section id="about" className="py-16 px-4 sm:px-6 max-w-4xl mx-auto">
      ...
      {/* Bio Card */}
      <div className="bg-[#f5f5f5] border-[0.5px] border-[#bbbbbb] rounded-[8px] p-6 sm:p-8 mb-8">
        {/* Profile Header within Card */}
        <div className="flex items-center gap-4 mb-6 pb-6 border-b border-[#bbbbbb]/40">
          ...
          <div>
            <h3 className="block text-[22px] font-bold tracking-tight text-[#999999]">{AISHA_INFO.name}</h3>
        ...
        {/* Highlight Stats Bar */}
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-8 pt-6 border-t border-[#bbbbbb]/40">
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Core Skills */}
        <div className="bg-[#f5f5f5] border-[0.5px] border-[#bbbbbb] rounded-[8px] p-6 shadow-2xs">
          ...
          <div className="flex flex-wrap gap-2">
            {AISHA_INFO.coreSkills.map((skill) => (
              <span
                key={skill}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-[8px] text-xs font-medium bg-[#f5f5f5] text-neutral-800 border-[0.5px] border-[#bbbbbb]"
              >
                {skill}
              </span>
            ))}
        ...
        <div className="bg-[#f5f5f5] border-[0.5px] border-[#bbbbbb] rounded-[8px] p-6 shadow-2xs">
          ...
          <div className="flex flex-wrap gap-2">
            {AISHA_INFO.additionalSkills.map((skill) => (
              <span
                key={skill}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-[8px] text-xs font-medium bg-[#f5f5f5] text-neutral-700 border-[0.5px] border-[#bbbbbb]"
              >
                {skill}
              </span>
            ))}
